...
const Header = () => {
  ...
  return (
    <header className="w-full bg-main-col shadow-lg">
      <section className="py-8 flex flex-row max-w-7xl mx-auto w-full justify-center gap-4 lg:gap-0 lg:justify-between relative">
        <section className="flex flex-row">
          ...
          <article className=" hidden lg:flex text-center justify-center px-4 py-2">
        ...
        <section
          ...
          className="lg:hidden flex justify-center items-center gap-2 cursor-pointer"
        >
          <GiHamburgerMenu
